...
const ReadOnlyField = ({
  ...
  return (
    <div className="mb-4 last:mb-0">
      <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-1.5 ml-1 dark:text-gray-500">
        {label}
      </label>
  ...
  return (
    <ModalInfo open={open} onClose={onClose} title="Détails de l'opération">
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-1 dark:bg-gray-800 dark:border-neutral-700">
        ...
        <div className="bg-gray-50 p-3 text-center border-t border-gray-100 rounded-b-xl dark:bg-gray-700 dark:border-gray-600">
